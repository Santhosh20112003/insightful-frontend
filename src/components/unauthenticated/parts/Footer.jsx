      ...
      <div className="px-5 py-8 bg-gray-50 mx-auto">
        <div className="flex flex-wrap md:text-left text-center">
          <div className="lg:w-1/4  w-full px-4">
            <h2 className="title-font text-gray-900 tracking-widest text-sm font-bold mb-3">
              LINKS
            </h2>
            <nav className="list-none mb-5">
              <li>
                {user ? <Link to="/dashboard" className="text-gray-500 hover:text-gray-800">Your Space</Link> : <Link to="/getaccess" className="text-gray-500 hover:text-gray-800">Get Access</Link>}
              </li>
              <li>
                <Link to="/story" className="text-gray-500 hover:text-gray-800">Story</Link>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4  w-full px-4">
            ...
            <nav className="list-none mb-5 ">
              <li>
                <Link to={ParentLink} className="text-gray-500 lg:hover:text-gray-800">Website</Link>
              </li>
              <li>
                <Link to="/terms-of-use" className="text-gray-500 hover:text-gray-800">Terms Of Use</Link>
              </li>
            </nav>
          </div>
      ...
      <div className="bg-gray-100">
        <div className="px-5 py-6 mx-auto flex flex-col items-center sm:flex-row">
          <span onClick={()=>{
            ...
            <span className="ml-2 font-serif font-semibold italic text-gray-600 text-xl">{AppName}</span>
          </span>
